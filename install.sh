...
declare -a BUILD_DEPENDS=(qtbase5-dev libqt5serialport5-dev libusb-1.0-0-dev libxrender-dev libavahi-core-dev libavahi-compat-libdnssd-dev libmbedtls-dev libpcre3-dev zlib1g-dev libjpeg-dev libqt5sql5-sqlite libssl-dev)
